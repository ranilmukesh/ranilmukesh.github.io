...
The framework separates fast edge sensing from slower cloud reasoning, which helps it react to live patient context without sending raw high-frequency data everywhere. In practical terms, it is trying to answer medical questions with awareness of what the body is doing right now, not just what the user typed.
