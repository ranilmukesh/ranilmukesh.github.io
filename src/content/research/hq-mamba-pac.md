...
date: 2026-05-02
pdfUrl: "/papers/hq mamba pac-flatten.pdf"
...
This paper tries to solve two problems at once: classical vision models become expensive at scale, while quantum models often become unstable to train. Its contribution is a hybrid design that uses quantum components where they may help representation and interaction, but still keeps the whole system practical enough for near-term hardware and real deployment scenarios.
